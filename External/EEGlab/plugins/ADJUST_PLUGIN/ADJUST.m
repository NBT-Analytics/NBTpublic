...
% GDSF =
% compute_GD_feat(topografie,EEG.chanlocs(EEG.icachansind),size(EEG.icawinv
% ,2)); modified (Giusi)
...
% [SED,medie_left,medie_right]=computeSED_NOnorm(topografie,EEG.chanlocs(EEG.icachansind),size(EEG.icawinv,2),size(EEG.icawinv,1)); 
%  modified (Giusi)
...
% [SAD,var_front,var_back,mean_front,mean_back]=computeSAD(topografie,EEG.chanlocs(EEG.icachansind),size(EEG.icawinv,2),size(EEG.icawinv,1));
%  modified (Giusi)
