% nbt_RemoveChan(Signal,SignalInfo, ChansToRemove)
%
%
%
% Usage:
...
function [Signal, SignalInfo, RemovedData, OldChanlocs] = nbt_RemoveChan(Signal,SignalInfo, ChToRemove)

% Remove Channels
ChRemain = nbt_negSearchVector(1:size(Signal,2), ChToRemove);
RemovedData = Signal(:, ChToRemove);
