% pop_runicaBadChannels() - Run an ICA decomposition of an EEG dataset using runica(),
%                binica(), or another ICA or other linear decomposition on
%                good channels only. The algoritm will remove bad channels
%                based on  NBTinfo.BadChannels
% Usage:
