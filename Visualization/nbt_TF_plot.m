...
function [W,t,frq] = nbt_TF_plot(Data, ChannelID,Frq_low,Frq_high,Frq_step,Plot_TFR);
%[W,t,frq] = TF_plot(NBTSignal,ChannelID ,Frq_low,Frq_high,Frq_step,Plot_TFR);
%**************************************************************************
% Purpose:
%
...
[W,p,s,coi] = nbt_wavelet33(Data(ChannelID),1/Fs,1,Frq_step,1.033*Frq_low,1.033*Frq_high);
